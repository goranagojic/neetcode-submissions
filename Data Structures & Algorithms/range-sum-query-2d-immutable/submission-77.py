class NumMatrix:
    ...
    def __init__(self, matrix: List[List[int]]):
        ...
        # check for m, n of zero size

        # TODO guard for matrix size
        print(len(matrix))
        print(len(matrix[0]))
        self.matrix = [row[:] for row in matrix]


        # TODO create cumulative sum matrix - first cum sum rows
        ...
        # TODO now calculate cum sum for rectangles
    ...
    def sumRegion(self, row1: int, col1: int, row2: int, col2: int) -> int:
        ...
        s22 = self.matrix[row2][col2] # s22 = row2, col2
